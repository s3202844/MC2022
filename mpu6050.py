...
class mpu6050:
    ...
    def __init__(self, address, bus=1):
        ...
        self.bus.write_byte_data(self.address, self.MPU_INT_EN_REG, 0x01)
        self.bus.write_byte_data(self.address, self.MPU_INTBP_CFG_REG, 0x80)
        self.bus.write_byte_data(self.address, self.SMPLRT_DIV, 0x27)
        # self.bus.write_byte_data(self.address, self.SMPLRT_DIV, 0x7c)
